<%-- 
    Document   : search
    Created on : Jul 6, 2021, 4:20:23 PM
    Author     : Thang
--%>
                        ...
                        <c:forEach var="dto" items="${result}" varStatus="counter">
                            ...
                            <c:if test="${not empty sessionScope.ADMIN}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ${dto.categoryName}
                                        <input type="hidden" name="txtCategory" value="${dto.categoryName}" />
                                    </td>
                                    <c:if test="${not empty sessionScope.ADMIN}">
                                        <c:if test="${sessionScope.ADMIN}">
                                            <td>
                                            ...
                                            <td>
                                                <c:url var="deleleLink" value="MainController">
                                                    <c:param name="btAction" value="Delete" />
                                                    <c:param name="txtId" value="${dto.bookID}" />
