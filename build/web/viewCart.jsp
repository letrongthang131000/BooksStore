<%-- 
    Document   : viewCart
    Created on : Jul 9, 2021, 7:22:14 PM
    Author     : Thang
--%>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <c:forEach var="item" items="${items}" varStatus="counter">
                                        <form action="MainController" id="cartForm">
                                            <tr>
                                                <td scope="row">
                                                    ${counter.count}
                                                </td>
                                ...
                                <form action="MainController">
                                    ...
                                    <td>
                                        ...
                                        <input 
                                            class="btn shadow-sm" 
                                            style="background-color: #FF8C00; color: #F0F8FF;" 
                                            type="submit" value="Pay momo" name="btAction" 
                                            onclick="return confirm('Chuyển dung so tien qua so dt:0904674961(LE TRONG THANG) voi noi dung: TENDANGNHAP + ngay thanh toan\n\
luu y : chuyen tien hoan tat hay bam OK ')"
                                            />
                                    </td>
                                    <td>
